...
class Items
{
    ...
    public QuestItems Name { get => _name; set => _name = value; }

    /// <summary>Item description</summary>
    public string Description { get => _description; set => _description = value; }

    /// <summary>Tuple for inventory images, Item1 greyed out image, Item2 active image</summary>
    public Tuple<Image, Image> ItemImages { get => _itemImages; set => _itemImages = value; }

    /// <summary>Items location in player inventory</summary>
    public Point InventoryLocation { get => _inventoryLocation; set => _inventoryLocation = value; }

    /// <summary>If item has interaction, it's target location</summary>
    public Point? TargetLocation { get => _targetLocation; set => _targetLocation = value; }

    /// <summary>Items interactions, if any</summary>
    public Interactions?[] Interaction { get => _interaction; set => _interaction = value; }

    /// <summary>Message on interaction</summary>
    public string InteractionMessage { get => _interactionMessage; set => _interactionMessage = value; }

    /// <summary>Error message if bad interaction</summary>
    public string[] ErrorMessage { get => _errorMessage; set => _errorMessage = value; }

    /// <summary>Property for name of objective</summary>
    public QuestItems? Reward { get => _reward; set => _reward = value; }
    #endregion

    #region ----- FIELDS
    private QuestItems _name;
    private string _description;
    private Tuple<Image, Image> _itemImages;
    private Point _inventoryLocation;
    private Point? _targetLocation;
    private Interactions?[] _interaction;
    private string _interactionMessage;
    private string[] _errorMessage;
    private QuestItems? _reward;
    ...
    public Items(QuestItems item)
    {
        ...
        switch (item)
        {
            case QuestItems.Rubber_Duck:
                _description = "Now what does this have to do with anything?";
                _itemImages = new Tuple<Image, Image>(InventoryImages.rubberduck_gray, InventoryImages.rubberduck_color);
                _inventoryLocation = new Point(0, 0);
                _errorMessage = [
                    $"[{_name.ReplaceUnderscore()}] Quack quack!!! ... {you} Did the duck just speak?... To me?... QUACK!!",
                    $"{you} Nah.",
                    $"{you} The idea was great, execution not so much",
                    $"{you} What's a nice {HelperMethods.ReplaceUnderscoreToString(_name)} like you doing in a place like this?",
                    $"{you} Back to the drawing board.",
                    $"{you} Hamburgers!"
                ];
                _targetLocation = new Point(14, 7);
                _interaction = [Interactions.Destroy_Item];
                _interactionMessage = $"{you} If it Quacks like a.. then it quacks like a... I was tired of your methodology anyway..";
                break;
            case QuestItems.Snake_Skin:
                this._description = "Just a snake skin..";
            ...
            case QuestItems.Rusty_Key:
                this._description = "The inscription reads. Passed down through generations";
            ...
            case QuestItems.Shard:
                this._description = "A relic shard.";
                ...
                this._reward = QuestItems.Raindeer_Dung;
                break;
            case QuestItems.Cat:
                this._description = "Hey there little fellow, no scratching.";
            ...
            case QuestItems.Red_Mushroom:
                this._description = "A red mushroom, looks peculiar.";
                ...
                this._reward = QuestItems.Green_Mushroom;
                break;
            case QuestItems.Green_Mushroom:
                this._description = "A green mushroom, looks funky.";
                ...
                this._reward = QuestItems.Yellow_Mushroom;
                break;
            case QuestItems.Yellow_Mushroom:
                this._description = "A yellow mushroom, combined from a red and a green one.. makes sense..";
                ...
                this._reward = QuestItems.Fishing_Rod;
                break;
            case QuestItems.Goat_Meat:
                this._description = "Hey here's the chunk of goat meat Tony kindly donated.";
            ...
            case QuestItems.Fishing_Rod:
                this._description = "Fishing Rod XL2000";
                ...
                this._reward = QuestItems.Knight_Helmet;
                break;
            case QuestItems.Burger:
                this._description = "A chunky burger, with extra cheese.";
                ...
                this._reward = QuestItems.Goat_Meat;
                break;
            case QuestItems.Pickaxe:
                this._description = "Ouch, better be careful with this one.";
            ...
            case QuestItems.Knight_Helmet:
                this._description = "Fit for a king, or me?";
                ...
                this._reward = QuestItems.Shard;
                break;
            case QuestItems.Raindeer_Nose:
                this._description = "Rudy outdid himself this time.";
                ...
                this._reward = QuestItems.Burger;
                break;
            case QuestItems.Raindeer_Dung:
                this._description = "Ewww.. to many blueberries..";
